...
class RecommendedRecycler(
    var listData:ArrayList<partner>)
    : RecyclerView.Adapter<RecommendedRecycler.ViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecommendedRecycler.ViewHolder{
        val view = LayoutInflater.from(parent.context).inflate(R.layout.recycler_layout,parent,false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: RecommendedRecycler.ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            var intent = Intent(it.context,Partner1::class.java)
